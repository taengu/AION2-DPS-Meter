...
graalvmNative {
    binaries {
        named("main") {
            ...
            buildArgs.add("--initialize-at-build-time=javafx,com.sun.javafx,com.sun.scenario.animation.SplineInterpolator,kotlinx.coroutines,kotlinx.coroutines.scheduling.DefaultScheduler,kotlin.coroutines.ContinuationInterceptor\$Key")
